...
// // Agregar el botón al documento (ajusta esto según tu estructura HTML)
// document.body.appendChild(verPaginaButton);

// // Agregar evento de clic al botón
// verPaginaButton.addEventListener('click', redirigirAPagina);

// // Puedes usar un bucle para iterar sobre todos los juegos en la lista
// for (let i = 0; i < juegosOferta.length; i++) {
//   const juego = juegosOferta[i];
//   // Realizar operaciones con cada juego
//   console.log(juego.title);
// }

// // O usar forEach para iterar
// juegosOferta.forEach(juego => {
//   // Realizar operaciones con cada juego
//   console.log(juego.title);
// });

// // La función para manejar el clic en el botón y redirigir a la oferta
...
//     const gameName = this.getAttribute('data-game-name'); // obtener el nombre del juego mediante data-game-name

//     // Redirigir a la URL de la tienda correspondiente
//     if (store === 'steam') {
//       window.location.href = `https://store.steampowered.com/app/${encodeURIComponent(gameId)}`;
//     } else if (store === 'epic') {
//       window.location.href = `https://www.epicgames.com/store/es-ES/p/${encodeURIComponent(gameId)}`;
//     } else {
